...
# This goes back one level to the 'clean-repo' root
...
# --- 2. LOAD DATA ---
logon_df = load_file('dataset/logon.csv')
device_df = load_file('dataset/device.csv')
http_df = load_file('dataset/http.csv')
email_df = load_file('dataset/email.csv')
